...
class TopCitiesAdapter constructor (private var selfList: ArrayList<CityCatageoryChild>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is CitiesViewHolder) {
            ...
            binding.llCity.setOnClickListener {
                adapterListener?.onClick( binding.llCity, position)
            }
